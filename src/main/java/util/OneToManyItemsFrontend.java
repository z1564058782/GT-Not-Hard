...
public class OneToManyItemsFrontend extends RecipeMapFrontend {

    public OneToManyItemsFrontend(BasicUIPropertiesBuilder uiPropertiesBuilder,
    ...
    public List<Pos2d> getItemOutputPositions(int itemOutputCount) {
        return UIHelper.getGridPositions(Math.min(itemOutputCount, 135), 7, 44, 9, 15);
    }
