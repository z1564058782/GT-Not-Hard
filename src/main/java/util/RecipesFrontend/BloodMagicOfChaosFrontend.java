...
public class BloodMagicOfChaosFrontend extends RecipeMapFrontend {

    public BloodMagicOfChaosFrontend(BasicUIPropertiesBuilder uiPropertiesBuilder,
        NEIRecipePropertiesBuilder neiRecipePropertiesBuilder) {
        super(
            uiPropertiesBuilder.logoPos(new Pos2d(150, 8)),
            neiRecipePropertiesBuilder.recipeBackgroundSize(new Size(170, 66)));
    }
    ...
    public List<Pos2d> getItemInputPositions(int itemInputCount) {
        ...
        int xOrigin_1 = 26;
        int yOrigin_1 = 8;
        int xDirMaxCount_1 = 1;
        int yDirMaxCount_1 = 1;
    ...
    public List<Pos2d> getItemOutputPositions(int itemOutputCount) {
        return UIHelper.getGridPositions(itemOutputCount, 130, 25, 1, 1);
    }

    public List<Pos2d> getFluidInputPositions(int fluidInputCount) {
        return UIHelper.getGridPositions(fluidInputCount, 62, 8, 1, 1);
    }
    ...
    public void addProgressBar(ModularWindow.Builder builder, Supplier<Float> progressSupplier, Pos2d windowOffset) {
        builder.widget(
            (new ProgressBar()).setTexture(GTUITextures.PROGRESSBAR_ARROW, 16)
                ...
                .setPos((new Pos2d(105, 25)).add(windowOffset))
                .setSize(20, 16));
    }
}
