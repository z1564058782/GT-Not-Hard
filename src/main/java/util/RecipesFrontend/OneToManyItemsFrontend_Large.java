...
public class OneToManyItemsFrontend_Large extends RecipeMapFrontend {

    public OneToManyItemsFrontend_Large(BasicUIPropertiesBuilder uiPropertiesBuilder,
    ...
    public List<Pos2d> getItemOutputPositions(int itemOutputCount) {
        return UIHelper.getGridPositions(Math.min(itemOutputCount, 90), 7, 44, 9, 10);
    }
