...
public class FluidReplicatorOfChaosFrontend extends RecipeMapFrontend {

    public FluidReplicatorOfChaosFrontend(BasicUIPropertiesBuilder uiPropertiesBuilder,
    ...
    public List<Pos2d> getItemInputPositions(int itemInputCount) {
        return UIHelper.getGridPositions(itemInputCount, 40, 8, 2, 1);
    }
    ...
    public List<Pos2d> getFluidInputPositions(int fluidInputCount) {
        return UIHelper.getGridPositions(fluidInputCount, 65, 8, 1, 1);
    }

    public List<Pos2d> getFluidOutputPositions(int fluidOutputCount) {
        return UIHelper.getGridPositions(fluidOutputCount, 115, 8, 1, 1);
    }
