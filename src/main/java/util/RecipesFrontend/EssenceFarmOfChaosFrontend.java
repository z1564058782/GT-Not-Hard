...
public class EssenceFarmOfChaosFrontend extends RecipeMapFrontend {

    public EssenceFarmOfChaosFrontend(BasicUIPropertiesBuilder uiPropertiesBuilder,
    ...
    public List<Pos2d> getItemInputPositions(int itemInputCount) {
        return UIHelper.getGridPositions(itemInputCount, 24, 36, 1, 2);
    }

    public List<Pos2d> getItemOutputPositions(int itemOutputCount) {
        return UIHelper.getGridPositions(itemOutputCount, 72, 8, 5, 5);
    }
    ...
    public void addProgressBar(ModularWindow.Builder builder, Supplier<Float> progressSupplier, Pos2d windowOffset) {
        builder.widget(
            (new ProgressBar()).setTexture(GTUITextures.PROGRESSBAR_ARROW, 16)
                ...
                .setPos((new Pos2d(48, 46)).add(windowOffset))
                .setSize(20, 16));
    }
}
