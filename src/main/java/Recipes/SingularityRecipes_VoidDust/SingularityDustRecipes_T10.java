    ...
    public static void addVoidDustRecipes_T10() {
        VoidDustRecipes_T10.put(
            ...
            new ItemStack[] {
                ...
                //
                Materials.BlackPlutonium.getDust(1), Materials.CallistoIce.getDust(1), Materials.Ledox.getDust(1),
                Materials.Quantium.getDust(1), Materials.Duralumin.getDust(1), Materials.Oriharukon.getDust(1),
                Materials.InfinityCatalyst.getDust(1), Materials.Bedrockium.getDust(1), Materials.Unstable.getDust(1),
                Materials.Infinity.getDust(1), Materials.MysteriousCrystal.getDust(1),
                Materials.SamariumMagnetic.getDust(1), Materials.Alumite.getDust(1), Materials.EndSteel.getDust(1),
                Materials.CrudeSteel.getDust(1), Materials.CrystallineAlloy.getDust(1),
                Materials.MelodicAlloy.getDust(1), Materials.StellarAlloy.getDust(1),
                Materials.CrystallinePinkSlime.getDust(1), Materials.EnergeticSilver.getDust(1),
                Materials.VividAlloy.getDust(1), MaterialsOreAlum.SluiceSand.getDust(1),
                MaterialsOreAlum.BauxiteSlag.getDust(1), MaterialsOreAlum.IlmeniteSlag.getDust(1),
                Materials.Alduorite.getDust(1), Materials.Rubracium.getDust(1), Materials.Vulcanite.getDust(1),
                Materials.Diamond.getDust(1), Materials.Emerald.getDust(1), Materials.Ruby.getDust(1),
                Materials.Sapphire.getDust(1), Materials.GreenSapphire.getDust(1), Materials.Olivine.getDust(1),
                Materials.NetherStar.getDust(1), Materials.Topaz.getDust(1), Materials.Tanzanite.getDust(1),
                Materials.Amethyst.getDust(1), Materials.Opal.getDust(1), Materials.Jasper.getDust(1),
                Materials.FoolsRuby.getDust(1), Materials.BlueTopaz.getDust(1), Materials.Amber.getDust(1),
                Materials.Dilithium.getDust(1), Materials.CertusQuartz.getDust(1), Materials.Forcicium.getDust(1),
                Materials.Forcillium.getDust(1), Materials.Monazite.getDust(1), Materials.Force.getDust(1),
                Materials.NetherQuartz.getDust(1), Materials.Quartzite.getDust(1), Materials.Lazurite.getDust(1),
                Materials.Sodalite.getDust(1), Materials.Lapis.getDust(1), Materials.GarnetRed.getDust(1),
                Materials.GarnetYellow.getDust(1), Materials.Vinteum.getDust(1), Materials.Apatite.getDust(1),
                Materials.Niter.getDust(1), Materials.EnderPearl.getDust(1), Materials.EnderEye.getDust(1),
                Materials.TricalciumPhosphate.getDust(1), Materials.Coal.getDust(1), Materials.Charcoal.getDust(1),
                Materials.Jade.getDust(1), Materials.Lignite.getDust(1), Materials.RoastedCopper.getDust(1),
                Materials.RoastedAntimony.getDust(1), Materials.RoastedIron.getDust(1),
                Materials.RoastedNickel.getDust(1), Materials.RoastedZinc.getDust(1),
                Materials.RoastedCobalt.getDust(1), Materials.RoastedArsenic.getDust(1),
                Materials.RoastedLead.getDust(1), Materials.ActivatedCarbon.getDust(1),
                Materials.PreActivatedCarbon.getDust(1), Materials.DirtyActivatedCarbon.getDust(1),

                Materials.TPV.getDust(1), MaterialsUEVplus.TranscendentMetal.getDust(1),
                Materials.EnrichedHolmium.getDust(1), MaterialsUEVplus.WhiteDwarfMatter.getDust(1),
                MaterialsUEVplus.BlackDwarfMatter.getDust(1), MaterialsUEVplus.SpaceTime.getDust(1),
                Materials.PotassiumNitrade.getDust(1), Materials.ChromiumTrioxide.getDust(1),
                Materials.Potassiumdichromate.getDust(1), Materials.Polybenzimidazole.getDust(1),
                Materials.Pyrochlore.getDust(1), Materials.BorosilicateGlass.getDust(1),
                Materials.FerriteMixture.getDust(1), Materials.NickelZincFerrite.getDust(1),
                Materials.Massicot.getDust(1), Materials.ArsenicTrioxide.getDust(1), Materials.CobaltOxide.getDust(1),
                Materials.Zincite.getDust(1), Materials.AntimonyTrioxide.getDust(1), Materials.CupricOxide.getDust(1),
                Materials.Ferrosilite.getDust(1), Materials.Magnesia.getDust(1), Materials.Quicklime.getDust(1),
                Materials.Potash.getDust(1), Materials.SodaAsh.getDust(1), Materials.Brick.getDust(1),
                Materials.Fireclay.getDust(1), Materials.SodiumBisulfate.getDust(1),
                Materials.PolyphenyleneSulfide.getDust(1), Materials.RawStyreneButadieneRubber.getDust(1),
                Materials.PhosphorousPentoxide.getDust(1), Materials.MetalMixture.getDust(1),
                Materials.SodiumHydroxide.getDust(1), Materials.SodiumCarbonate.getDust(1),
                Materials.SodiumAluminate.getDust(1), WerkstoffLoader.Alumina.get(OrePrefixes.dust, 1),
                Materials.Aluminiumhydroxide.getDust(1), Materials.Cryolite.getDust(1),
                Materials.SodiumSulfide.getDust(1), Materials.SodiumOxide.getDust(1),
                MaterialsKevlar.SodiumMethoxide.getDust(1), MaterialsKevlar.SodiumHydride.getDust(1),
                MaterialsKevlar.Triphenylphosphene.getDust(1), MaterialsKevlar.RhodiumChloride.getDust(1),
                MaterialsKevlar.SodiumBorohydride.getDust(1), MaterialsKevlar.OrganorhodiumCatalyst.getDust(1),
                MaterialsKevlar.CobaltIINitrate.getDust(1), MaterialsKevlar.CobaltIIAcetate.getDust(1),
                MaterialsKevlar.CobaltIIHydroxide.getDust(1), MaterialsKevlar.CobaltIINaphthenate.getDust(1),
                MaterialsKevlar.Kevlar.getDust(1), MaterialsKevlar.BismuthIIIOxide.getDust(1),
                Materials.HeeEndium.getDust(1), MaterialsKevlar.RaneyNickelActivated.getDust(1),
                MaterialsKevlar.NickelAluminide.getDust(1), MaterialsKevlar.IIButinIIVdiol.getDust(1),
                MaterialsKevlar.CalciumCarbide.getDust(1), MaterialsKevlar.ParaPhenylenediamine.getDust(1),
                MaterialsKevlar.TerephthaloylChloride.getDust(1), MaterialsKevlar.Pentaerythritol.getDust(1),
                MaterialsKevlar.KevlarCatalyst.getDust(1), MaterialsKevlar.DiphenylmethaneDiisocyanate.getDust(1),
                Materials.Calciumhydride.getDust(1), Materials.Flint.getDust(1), Materials.Obsidian.getDust(1),
                Materials.Clay.getDust(1), Materials.Netherrack.getDust(1), Materials.Endstone.getDust(1),
                Materials.Electrotine.getDust(1), Materials.Bluestone.getDust(1), Materials.NetherBrick.getDust(1),
                Materials.HydratedCoal.getDust(1), Materials.Graphene.getDust(1), Materials.Almandine.getDust(1),
                Materials.Andradite.getDust(1), Materials.Bauxite.getDust(1), Materials.Calcite.getDust(1),
                Materials.Cassiterite.getDust(1), Materials.Chromite.getDust(1), Materials.Cinnabar.getDust(1),
                Materials.Cobaltite.getDust(1), Materials.Cooperite.getDust(1), Materials.DeepIron.getDust(1),
                Materials.Galena.getDust(1), Materials.Grossular.getDust(1), Materials.LiveRoot.getDust(1),
                Materials.Phosphate.getDust(1), Materials.Pyrite.getDust(1), Materials.Pyrope.getDust(1),
                Materials.Saltpeter.getDust(1), Materials.SiliconDioxide.getDust(1), Materials.Spessartine.getDust(1),
                Materials.Sphalerite.getDust(1), Materials.Tetrahedrite.getDust(1), Materials.Tungstate.getDust(1),
                Materials.Uvarovite.getDust(1), Materials.Pyrotheum.getDust(1), Materials.Basalt.getDust(1),
                Materials.Marble.getDust(1), Materials.Redrock.getDust(1), Materials.PotassiumFeldspar.getDust(1),
                Materials.Biotite.getDust(1), Materials.GraniteBlack.getDust(1), Materials.GraniteRed.getDust(1),
                Materials.Blizz.getDust(1), Materials.CobaltHexahydrate.getDust(1),
                Materials.ConstructionFoam.getDust(1), Materials.Chalcopyrite.getDust(1),
                Materials.SiliconSG.getDust(1), Materials.CrudeOil.getDust(1), Materials.Emery.getDust(1),
                MaterialsGTNH.Epidote.getDust(1), Materials.Graphite.getDust(1), Materials.Greenstone.getDust(1),
                Materials.Trinium.getDust(1), Materials.Magnetite.getDust(1), Materials.Malachite.getDust(1),
                Materials.Migmatite.getDust(1), Materials.Siltstone.getDust(1), Materials.Soapstone.getDust(1),
                Materials.Oilsands.getDust(1), Materials.Wulfenite.getDust(1), Materials.Powellite.getDust(1),
                Materials.Desh.getDust(1), Materials.Glass.getDust(1), Materials.RawRubber.getDust(1),
                Materials.Cryotheum.getDust(1), Materials.Mirabilite.getDust(1), Materials.Mica.getDust(1),
                Materials.Trona.getDust(1), Materials.Barite.getDust(1), Materials.Bastnasite.getDust(1),
                Materials.Garnierite.getDust(1), Materials.Lepidolite.getDust(1), Materials.Magnesite.getDust(1),
                Materials.Pentlandite.getDust(1), Materials.Scheelite.getDust(1), Materials.Alunite.getDust(1),
                Materials.Chrysotile.getDust(1), Materials.Realgar.getDust(1), Materials.Dolomite.getDust(1),
                Materials.Wollastonite.getDust(1), Materials.Zeolite.getDust(1), Materials.BandedIron.getDust(1),
                Materials.Ilmenite.getDust(1), Materials.Pollucite.getDust(1), Materials.Spodumene.getDust(1),
                Materials.Tantalite.getDust(1), Materials.Uraninite.getDust(1), Materials.VanadiumMagnetite.getDust(1),
                Materials.Kyanite.getDust(1), Materials.Perlite.getDust(1), Materials.Pumice.getDust(1),
                Materials.BrownLimonite.getDust(1), Materials.YellowLimonite.getDust(1),
                Materials.Glauconite.getDust(1), Materials.Gypsum.getDust(1), Materials.Borax.getDust(1),
                Materials.Molybdenite.getDust(1), Materials.Pyrolusite.getDust(1), Materials.Stibnite.getDust(1),
                Materials.Asbestos.getDust(1), Materials.Concrete.getDust(1), Materials.Diatomite.getDust(1),
                Materials.Vyroxeres.getDust(1), Materials.Ceruclase.getDust(1), Materials.Tartarite.getDust(1),
                Materials.Orichalcum.getDust(1), Materials.AluminiumFluoride.getDust(1), Materials.Void.getDust(1),
                Materials.CalciumDisilicide.getDust(1), Materials.SuperconductorUEVBase.getDust(1),
                Materials.Draconium.getDust(1), Materials.DraconiumAwakened.getDust(1),
                Materials.BloodInfusedIron.getDust(1), Materials.Ichorium.getDust(1), Materials.RadoxPolymer.getDust(1),
                Materials.GalliumArsenide.getDust(1), Materials.IndiumGalliumPhosphide.getDust(1),
                Materials.CosmicNeutronium.getDust(1), Materials.Flerovium.getDust(1),
                ...
                Materials.Titaniumonabariumdecacoppereikosaoxid.getDust(1), Materials.Uraniumtriplatinid.getDust(1),
