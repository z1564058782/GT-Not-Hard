    ...
    public static void addVoidDustRecipes_T5() {
        ...
        VoidDustRecipes_T5.put(
            ...
            new ItemStack[] {
                ...
                Materials.Calcium.getDust(1), Materials.Copper.getDust(1), Materials.Iron.getDust(1),
                Materials.Lead.getDust(1), Materials.SiliconDioxide.getDust(1), Materials.Vanadium.getDust(1),
                Materials.Zinc.getDust(1),

                WerkstoffLoader.DescloiziteCUVO4.get(OrePrefixes.dust, 1),
                WerkstoffLoader.DescloiziteZNVO4.get(OrePrefixes.dust, 1),
                WerkstoffLoader.Hedenbergit.get(OrePrefixes.dust, 1), WerkstoffLoader.Fayalit.get(OrePrefixes.dust, 1),

                // Prasiolite & Hedenbergite Vein
                Materials.Amethyst.getDust(1), Materials.Calcium.getDust(1), Materials.Iron.getDust(1),
                ...
                // BArTiMaEuSNeK Vein
                Materials.Boron.getDust(1), Materials.Europium.getDust(1), Materials.Titanium.getDust(1),
                ...
                // Fluorspar Vein
                Materials.Barite.getDust(1), Materials.Cadmium.getDust(1), Materials.Galena.getDust(1),
                Materials.Gallium.getDust(1), Materials.GarnetYellow.getDust(1), Materials.Lead.getDust(1),
                Materials.Silver.getDust(1), Materials.Sulfur.getDust(1), Materials.Zinc.getDust(1),
