        ...
        // Avaritia
        {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    // "Infinity Catalyst"
                    getModItem(Avaritia.ID, "Resource", 1L, 5),
                    // "Crystal Matrix"
                    getModItem(Avaritia.ID, "Crystal_Matrix", 4L),
                    // "Electric Motor (UV)"
                    getModItem(GregTech.ID, "gt.metaitem.01", 2L, 32608),
                    // "Emitter (UV)"
                    getModItem(GregTech.ID, "gt.metaitem.01", 4L, 32687),
                    // "Sensor (UV)"
                    getModItem(GregTech.ID, "gt.metaitem.01", 4L, 32697))
                .fluidInputs(
                    // "Molten Black Plutonium"
                    FluidRegistry.getFluidStack("molten.blackplutonium", 144 * 9 * 4),
                    // "Molten Cosmic Neutronium"
                    FluidRegistry.getFluidStack("molten.cosmicneutronium", 144 * (9 * 8 + 8 * 8)),
                    // "Molten Infinity"
                    FluidRegistry.getFluidStack("molten.infinity", 144 * 4),
                    // "Molten Bedrockium"
                    FluidRegistry.getFluidStack("molten.bedrockium", 144 * 8 * 10))
                .itemOutputs(getModItem(Avaritia.ID, "Neutron_Collector", 1L))
                .duration(SECONDS)
                .eut(RECIPE_LV)
                .addTo(addChaosXtremeCraftingRecipes);
        }
        ...
        // AE2FluidCraft
        {
            ...
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    FluidRegistry.getFluidStack("molten.cosmicneutronium", 144 * 9 * 4),
                    FluidRegistry.getFluidStack("molten.neutronium", 144 * 9 * 8))
                .itemOutputs(getModItem(AE2FluidCraft.ID, "fluid_storage.quantum", 1L))
                .duration(SECONDS)
                .eut(RECIPE_LV)
                .addTo(addChaosXtremeCraftingRecipes);
        ...
        // GregTech
        {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    getModItem(Avaritia.ID, "Resource", 20L, 1),
                    // "Ultimate Matter Constrictor"
                    getModItem(GregTech.ID, "gt.blockmachines", 1L, 10812),
                    // "Electric Motor (UV)"
                    getModItem(GregTech.ID, "gt.metaitem.01", 4L, 32608),
                    // "Conveyor Module (UV)"
                    getModItem(GregTech.ID, "gt.metaitem.01", 8L, 32637),
                    // "Electric Piston (UV)"
                    getModItem(GregTech.ID, "gt.metaitem.01", 8L, 32647))
                .fluidInputs(
                    // "Molten Bedrockium"
                    FluidRegistry.getFluidStack("molten.bedrockium", 144 * 64 * 2),
                    // "Molten Black Plutonium"
                    FluidRegistry.getFluidStack("molten.blackplutonium", 144 * 64 * 2),
                    // "Molten Cosmic Neutronium"
                    FluidRegistry.getFluidStack("molten.cosmicneutronium", 144 * (9 * 12 + 8 * 4)),
                    // "Molten Neutronium"
                    FluidRegistry.getFluidStack("molten.neutronium", 144 * 4))
                .itemOutputs(getModItem(GregTech.ID, "gt.blockmachines", 1L, 3007))
                .duration(SECONDS)
                .eut(RECIPE_LV)
                .addTo(addChaosXtremeCraftingRecipes);
        }
        ...
        // Singularity
        {
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    // "Golden Singularity"
                    getModItem(Avaritia.ID, "Singularity", 1L, 1),
                    // "Lapis Singularity"
                    getModItem(Avaritia.ID, "Singularity", 1L, 2),
                    // "Redstone Singularity"
                    getModItem(Avaritia.ID, "Singularity", 1L, 3),
                    // "Nether Quartz Singularity"
                    getModItem(Avaritia.ID, "Singularity", 1L, 4),
                    // "Copper Singularity"
                    getModItem(Avaritia.ID, "Singularity", 1L, 5),
                    // "Tin Singularity"
                    getModItem(Avaritia.ID, "Singularity", 1L, 6),
                    // "Leaden Singularity"
                    getModItem(Avaritia.ID, "Singularity", 1L, 7),
                    // "Silver Singularity"
                    getModItem(Avaritia.ID, "Singularity", 1L, 8))
                .fluidInputs(
                    // "Molten Bedrockium"
                    FluidRegistry.getFluidStack("molten.bedrockium", 144 * 9 * 4),
                    // "Molten Black Plutonium"
                    FluidRegistry.getFluidStack("molten.blackplutonium", 144 * 9 * 12))
                .itemOutputs(getModItem(EternalSingularity.ID, "combined_singularity", 1L, 0))
                .duration(SECONDS)
                .eut(RECIPE_LV)
                .addTo(addChaosXtremeCraftingRecipes);
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    // "Nickel Singularity"
                    getModItem(Avaritia.ID, "Singularity", 1L, 9),
                    // "Enderium Singularity"
                    getModItem(Avaritia.ID, "Singularity", 1L, 10),
                    // "Aluminum Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 0),
                    // "Brass Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 1),
                    // "Bronze Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 2),
                    // "Charcoal Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 3),
                    // "Coal Singularity"
                    getModItem(UniversalSingularities.ID, "universal.vanilla.singularity", 1L, 0),
                    // "Emerald Singularity"
                    getModItem(UniversalSingularities.ID, "universal.vanilla.singularity", 1L, 1),
                    // "Diamond Singularity"
                ...
                .fluidInputs(
                    ...
                    // "Molten Black Plutonium"
                    FluidRegistry.getFluidStack("molten.blackplutonium", 144 * 9 * 12))
                .itemOutputs(getModItem(EternalSingularity.ID, "combined_singularity", 1L, 1))
                .duration(SECONDS)
                .eut(RECIPE_LV)
                .addTo(addChaosXtremeCraftingRecipes);
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 4),
                    // "Invar Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 5),
                    // "Magnesium Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 6),
                    // "Osmium Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 7),
                    // "Peridot Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 8),
                    // "Ruby Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 9),
                    // "Sapphire Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 10),
                    // "Steel Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 11),
                    // "Titanium Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 12))
                .fluidInputs(
                    // "Molten Bedrockium"
                    FluidRegistry.getFluidStack("molten.bedrockium", 144 * 9 * 4),
                    // "Molten Black Plutonium"
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 13),
                    // "Uranium Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 14),
                    // "Zinc Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 15),
                    // "Tricalcium Phosphate Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 16),
                    // "Palladium Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 17),
                    // "Damascus Steel Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 18),
                    // "Black Steel Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 19),
                    // "Fluxed Electrum Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 20),
                    // "Quicksilver Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 21))
                .fluidInputs(
                    // "Molten Bedrockium"
                    FluidRegistry.getFluidStack("molten.bedrockium", 144 * 9 * 4),
                    // "Molten Black Plutonium"
                    FluidRegistry.getFluidStack("molten.blackplutonium", 144 * 9 * 12))
                .itemOutputs(getModItem(EternalSingularity.ID, "combined_singularity", 1L, 3))
                .duration(SECONDS)
                .eut(RECIPE_LV)
                .addTo(addChaosXtremeCraftingRecipes);
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    // "Shadow Steel Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 22),
                    // "Iridium Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 23),
                    // "Nether Star Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 24),
                    // "Platinum Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 25),
                    // "Naquadria Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 26),
                    // "Plutonium Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 27),
                    // "Meteoric Iron Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 28),
                    // "Desh Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 29),
                    // "Europium Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 30))
                .fluidInputs(
                    // "Molten Bedrockium"
                    FluidRegistry.getFluidStack("molten.bedrockium", 144 * 9 * 4),
                    // "Molten Black Plutonium"
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    // "Draconium Singularity"
                    getModItem(UniversalSingularities.ID, "universal.draconicEvolution.singularity", 1L, 0),
                    // "Awakened Draconium Singularity"
                    getModItem(UniversalSingularities.ID, "universal.draconicEvolution.singularity", 1L, 1),
                    // "Conductive Iron Singularity"
                    getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1L, 0),
                    // "Electrical Steel Singularity"
                    getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1L, 1),
                    // "Energetic Alloy Singularity"
                    getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1L, 2),
                    // "Dark Steel Singularity"
                    getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1L, 3),
                    // "Pulsating Iron Singularity"
                    getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1L, 4),
                    // "Redstone Alloy Singularity"
                    getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1L, 5),
                    // "Soularium Singularity"
                    getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1L, 6))
                .fluidInputs(
                    // "Molten Bedrockium"
                    FluidRegistry.getFluidStack("molten.bedrockium", 144 * 9 * 4),
                    // "Molten Black Plutonium"
                    FluidRegistry.getFluidStack("molten.blackplutonium", 144 * 9 * 12))
                .itemOutputs(getModItem(EternalSingularity.ID, "combined_singularity", 1L, 5))
                .duration(SECONDS)
                .eut(RECIPE_LV)
                .addTo(addChaosXtremeCraftingRecipes);
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    ...
                    getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1L, 7),
                    // "Unstable Ingot Singularity"
                    getModItem(UniversalSingularities.ID, "universal.extraUtilities.singularity", 1L, 0),
                    // "Rose Gold Singularity"
                    getModItem(UniversalSingularities.ID, "universal.general.singularity", 1L, 32),
                    // "Electrotine Singularity"
                    getModItem(UniversalSingularities.ID, "universal.projectRed.singularity", 1L, 0),
                    // "Obzinite Singularity"
                    getModItem(UniversalSingularities.ID, "universal.tinkersConstruct.singularity", 1L, 1),
                    // "Ardite Singularity"
                    getModItem(UniversalSingularities.ID, "universal.tinkersConstruct.singularity", 1L, 2),
                    // "Cobalt Singularity"
                    getModItem(UniversalSingularities.ID, "universal.tinkersConstruct.singularity", 1L, 3),
                    // "Ender Singularity"
                    getModItem(UniversalSingularities.ID, "universal.tinkersConstruct.singularity", 1L, 4),
                    // "Manyullyn Singularity"
                    getModItem(UniversalSingularities.ID, "universal.tinkersConstruct.singularity", 1L, 6))
                .fluidInputs(
                    // "Molten Bedrockium"
                    FluidRegistry.getFluidStack("molten.bedrockium", 144 * 9 * 4),
                    // "Molten Black Plutonium"
                    FluidRegistry.getFluidStack("molten.blackplutonium", 144 * 9 * 12))
                .itemOutputs(getModItem(EternalSingularity.ID, "combined_singularity", 1L, 6))
                .duration(SECONDS)
                .eut(RECIPE_LV)
                .addTo(addChaosXtremeCraftingRecipes);
            ...
            GTValues.RA.stdBuilder()
                .itemInputs(
                    // "Nitronic Singularity"
                    getModItem(EternalSingularity.ID, "combined_singularity", 1L, 0),
                    // "Psychotic Singularity"
                    getModItem(EternalSingularity.ID, "combined_singularity", 1L, 1),
                    // "Sphaghettic Singularity"
                    getModItem(EternalSingularity.ID, "combined_singularity", 1L, 2),
                    // "Pneumatic Singularity"
                    getModItem(EternalSingularity.ID, "combined_singularity", 1L, 3),
                    // "Cryptic Singularity"
                    getModItem(EternalSingularity.ID, "combined_singularity", 1L, 4),
                    // "Historic Singularity"
                    getModItem(EternalSingularity.ID, "combined_singularity", 1L, 5),
                    // "Meteoric Singularity"
                    getModItem(EternalSingularity.ID, "combined_singularity", 1L, 6))
                .fluidInputs(
                    // "Molten Black Plutonium"
                    FluidRegistry.getFluidStack("molten.blackplutonium", 144 * 9 * 12),
                    // "Molten Cosmic Neutronium"
                    FluidRegistry.getFluidStack("molten.cosmicneutronium", 144 * 9 * 10))
