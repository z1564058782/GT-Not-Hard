...
public class ChaosEssenceFarmRecipes {
    ...
    public static void addEssenceFarmRecipes() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                setStackSize(MagicItemNBT.Phial_of_Essentia_Aer, 1),
                setStackSize(MagicItemNBT.Phial_of_Essentia_Terra, 1),
                setStackSize(MagicItemNBT.Phial_of_Essentia_Ignis, 1),
                setStackSize(MagicItemNBT.Phial_of_Essentia_Aqua, 1),
                setStackSize(MagicItemNBT.Phial_of_Essentia_Ordo, 1),
                setStackSize(MagicItemNBT.Phial_of_Essentia_Perditio, 1),
                setStackSize(MagicItemNBT.Phial_of_Essentia_Vacuos, 1),
                setStackSize(MagicItemNBT.Phial_of_Essentia_Lux, 1),
                ...
                setStackSize(MagicItemNBT.Phial_of_Essentia_Sano, 1),
                setStackSize(MagicItemNBT.Phial_of_Essentia_Iter, 1))
            .duration(SECONDS)
            .eut(RECIPE_LV)
            .addTo(addEssenceFarmRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                setStackSize(MagicItemNBT.Phial_of_Essentia_Meto, 1),
                setStackSize(MagicItemNBT.Phial_of_Essentia_Telum, 1),
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                setStackSize(MagicItemNBT.Phial_of_Essentia_Ira, 1),
                setStackSize(MagicItemNBT.Phial_of_Essentia_Tempus, 1),
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                setStackSize(MagicItemNBT.Ethereal_Essence_Aer, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Terra, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Ignis, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Aqua, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Ordo, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Perditio, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Vacuos, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Lux, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Tempestas, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Motus, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Gelum, 1),
                ...
                setStackSize(MagicItemNBT.Ethereal_Essence_Sano, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Iter, 1))
            .duration(SECONDS)
            .eut(RECIPE_LV)
            .addTo(addEssenceFarmRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                setStackSize(MagicItemNBT.Ethereal_Essence_Auram, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Vitium, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Limus, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Herba, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Arbor, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Bestia, 1),
                ...
                setStackSize(MagicItemNBT.Ethereal_Essence_Meto, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Telum, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Tutamen, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Fames, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Lucrum, 1),
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                setStackSize(MagicItemNBT.Ethereal_Essence_Gula, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Invidia, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Desidia, 1),
                setStackSize(MagicItemNBT.Ethereal_Essence_Ira, 1),
