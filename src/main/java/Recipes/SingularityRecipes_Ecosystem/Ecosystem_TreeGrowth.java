...
public class Ecosystem_TreeGrowth {

    // Minecraft
    public static final ItemStack[] Minecraft_TreeGrowth = new ItemStack[] {
        // "Oak Sapling"
        ...
        // Brown Mushroom
        getModItem(Minecraft.ID, "brown_mushroom_block", 1L), // Brown Mushroom
        getModItem(Minecraft.ID, "brown_mushroom", 1L), // Brown Mushroom
        getModItem(EtFuturumRequiem.ID, "brown_mushroom", 1L), // Brown Mushroom

        // Red Mushroom
        getModItem(Minecraft.ID, "red_mushroom_block", 1L), // Red Mushroom
        getModItem(Minecraft.ID, "red_mushroom", 1L), // Red Mushroom
        getModItem(EtFuturumRequiem.ID, "red_mushroom", 1L) // Red Mushroom
    };

    // IndustrialCraft2
    public static final ItemStack[] IndustrialCraft2_TreeGrowth = new ItemStack[] {
        // "Rubber Tree Sapling"
    ...
    // TinkerConstruct
    public static final ItemStack[] TinkerConstruct_TreeGrowth = new ItemStack[] {
        // "Slimy Sapling"
    ...
    // GTPlusPlus
    public static final ItemStack[] GTPlusPlus_TreeGrowth = new ItemStack[] {
    ...
    // TwilightForest
    public static final ItemStack[] TwilightForest_TreeGrowth = new ItemStack[] {
    ...
    // GalaxySpace
    public static final ItemStack[] GalaxySpace_TreeGrowth = new ItemStack[] {
        // "Barnarda C Sapling"
    ...
    // GalacticraftAmunRa
    public static final ItemStack[] GalacticraftAmunRa_TreeGrowth = new ItemStack[] {
        // "Virilig Sapling"
    ...
    // Thaumcraft
    public static final ItemStack[] Thaumcraft_TreeGrowth = new ItemStack[] {
        // "Greatwood Sapling"
    ...
    // ThaumicBases
    public static final ItemStack[] ThaumicBases_TreeGrowth = new ItemStack[] {
        // "Golden Oak Sapling"
    ...
    // TaintedMagic
    public static final ItemStack[] TaintedMagic_TreeGrowth = new ItemStack[] {
        // "Warpwood Sapling"
    ...
    // ForbiddenMagic
    public static final ItemStack[] ForbiddenMagic_TreeGrowth = new ItemStack[] {
        // "Tainted Sapling"
    ...
    // Witchery
    public static final ItemStack[] Witchery_TreeGrowth = new ItemStack[] {
        // "Rowan Sapling"
    ...
    // Natura
    public static final ItemStack[] Natura_TreeGrowth = new ItemStack[] {
        // "Redwood Sapling"
    ...
    // BiomesOPlenty
    public static final ItemStack[] BiomesOPlenty_TreeGrowth = new ItemStack[] {
        // "Apple Sapling"
    ...
    // PamsHarvestCraft
    public static final ItemStack[] PamsHarvestCraft_TreeGrowth = new ItemStack[] {
        // "Apple Sapling"
    ...
    // Forestry
    public static final ItemStack[] Forestry_TreeGrowth = new ItemStack[] {
        // "Apple Oak Sapling"
        getModItem(Minecraft.ID, "log", 1L, 0), // "Oak Log"
        getModItem(Minecraft.ID, "apple", 1L), // Apple
    ...
    // ExtraTrees
    public static final ItemStack[] ExtraTrees_TreeGrowth = new ItemStack[] {
